static NSString * const CustomCarrierPreferencesFile = @"/var/mobile/Library/Preferences/com.leroy.CustomCarrierPreferences.plist";
...
- (id)_sbCarrierNameForOperator:(id)arg1 {
  ...
  NSDictionary *settings = [NSDictionary dictionaryWithContentsOfFile: CustomCarrierPreferencesFile];
